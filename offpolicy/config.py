...
def get_config():
    ...
    parser.add_argument("--algorithm_name", type=str, default="rmatd3", choices=[
                        "rmaddpg", "qtran","qmix", "vdn", "matd3", "maddpg", "masac", "mqmix", "mvdn","dcg","rddfg_cent_rw"])
    ...
    parser.add_argument('--adj_lambda', type=float, default=1,
                        help="adj_lambda")
    ...
    parser.add_argument('--lambda_opt', type=int, default=1,
                        help="Dimension of hidden layer of qtran network")
    parser.add_argument('--lambda_nopt', type=int, default=1,
                        help="Dimension of hidden layer of qtran network")
