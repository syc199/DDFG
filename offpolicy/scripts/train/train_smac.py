...
def main(args):
    ...
    if all_args.use_dyn_graph == False and all_args.equal_vdn == False and all_args.algorithm_name in ["rmdfg","rmdfg_cent","rddfg_cent_rw","rmfg_cent"]:
        ...
        num_factor = get_map_params(all_args.map_name)["n_enemies"]
    ...
    # choose algo
    if all_args.algorithm_name in ["rmaddpg", "qtran","qmix", "vdn","rddfg_cent_rw","dcg"]:
    ...
    index = 0
    n = 0
    if all_args.use_dyn_graph == False and all_args.equal_vdn == False and all_args.algorithm_name in ["rddfg_cent_rw","dcg"]:
